...
function buscarMusica(idMusica) {
    ...
    var instrucaoSql = `SELECT m.id_musica, m.nome AS nome_musica, a.id_album, a.nome AS nome_album FROM musica m JOIN album a ON m.fk_album = a.id_album WHERE m.id_musica = ${idMusica}`
